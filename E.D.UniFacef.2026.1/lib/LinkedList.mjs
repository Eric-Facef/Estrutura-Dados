...
export default class LinkedList {
  ...
  peek(pos) {
    ...
    // 2° caso busca sequencial = buscar na sequencia
    let node = this.#head
  ...
  // metodo para retornar (sem remover) o valor do primeiro da lista (atalho)
  peekHead() {
    return this.peek(0)
  }
  // metodo para retornar (sem remover) o valor do ultimo da lista (atalho)
  peekTail() {
